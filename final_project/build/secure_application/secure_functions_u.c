...
static sgx_status_t SGX_CDECL secure_functions_sgx_thread_wait_untrusted_event_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL secure_functions_sgx_thread_set_untrusted_event_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL secure_functions_sgx_thread_setwait_untrusted_events_ocall(void* pms)
{
...
static sgx_status_t SGX_CDECL secure_functions_sgx_thread_set_multiple_untrusted_events_ocall(void* pms)
{
...
static const struct {
	...
	6,
	{
		...
		(void*)(uintptr_t)secure_functions_sgx_thread_setwait_untrusted_events_ocall,
		(void*)(uintptr_t)secure_functions_sgx_thread_set_multiple_untrusted_events_ocall,
	}
};
